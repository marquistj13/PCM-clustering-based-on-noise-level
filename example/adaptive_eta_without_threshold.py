...
from algorithms import npcm_eta_zero
...
if __name__ == '__main__':
    ...
    plt.savefig(r".\video\adaptive_eta_without_threshold_ori.png", dpi=dpi, bbox_inches='tight')
    ...
    n_cluster, sigma_v, alpha_cut = 10, 1, 0.1
    ini_save_name = r"..\paper\img\adaptive_eta_without_threshold_ini.png"
    last_frame_name = r'..\paper\img\adaptive_eta_without_threshold_last_frame.png'
    tmp_video_name = r'.\video\adaptive_eta_without_threshold_n_%d_sigmav_%.1f_alpha_%.1f_tmp.mp4' % (
